...
public sealed class
    ModulesExtensionsMethodsTypesCompilationTransformer : ICompilationTransformer<ImmutableArray<TypeModel>>
{
    private const string Namespace1 = "DependencyManagement";

    private const string Namespace2 = "Modularity";
    ...
    private const string GeneratedExtensionMethodPrefixName = "WithModulesFrom";
